...
export const chapters: Chapter[] = [
  ...
  },
  {
    ...
    keyVerses: [
      {
        reference: "希伯来书 2:1",
        text: "所以，我们当越发郑重所听见的道理，恐怕我们随流失去。",
      },
      {
        reference: "希伯来书 2:14",
  ...
  },
  {
    ...
    keyVerses: [
      {
        reference: "希伯来书 3:1",
        text: "所以，同蒙天召的圣洁弟兄啊，你们应当思想我们所认为使者、为大祭司的耶稣。",
      },
      {
        reference: "希伯来书 3:13",
        text: "总要趁着还有今日，天天彼此相劝，免得你们中间有人被罪迷惑，心里就刚硬了。",
      },
      {
        reference: "希伯来书 3:6",
  ...
  },
  {
    ...
    keyVerses: [
      ...
      {
        reference: "希伯来书 5:12",
        text: "看你们学习的工夫，本该作师傅，谁知还得有人将神圣言小学的开端另教导你们，并且成了那必须吃奶，不能吃干粮的人。",
      },
    ],
    keyPoints: [
      "大祭司是从人间挑选，替人在神面前行事",
  ...
  },
  {
    ...
    keyVerses: [
      {
        reference: "希伯来书 6:1-2",
        text: "所以，我们应当离开基督道理的开端，竭力进到完全的地步；不必再立根基，就如那懊悔死行、信靠神、各样洗礼、按手之礼、死人复活，以及永远审判各等教训。",
      },
      {
        reference: "希伯来书 6:18-19",
        text: "借这两件不更改的事，神决不能说谎，好叫我们这逃往避难所、持定摆在我们前头指望的人可以大得勉励；我们有这指望，如同灵魂的锚，又坚固又牢靠，且通入幔内。",
      },
    ],
    keyPoints: [
...
export const questions: Question[] = [
  ...
  },
  {
    ...
    answer: 2,
    explanation: "希伯来书2:14说，耶稣成为血肉之体，特要借着死，败坏那掌死权，就是魔鬼。",
  },
  {
    id: "c2-mc-5",
    type: "multiple-choice",
  ...
  },
  {
    ...
    answer: "随流",
    hint: "希伯来书2:1",
    explanation: "希伯来书2:1：所以，我们当越发郑重所听见的道理，恐怕我们随流失去。",
  },
  {
    id: "c2-fb-2",
    type: "fill-blank",
  ...
  },
  {
    ...
    type: "fill-blank",
    chapter: 3,
    question: "希伯来书3:13说，总要趁着还有今日，天天彼此___，免得你们中间有人被罪迷惑，心里就刚硬了。",
    answer: "相劝",
    hint: "希伯来书3:13",
    explanation: "希伯来书3:13：总要趁着还有今日，天天彼此相劝。",
  },
  {
    id: "c3-fb-2",
    type: "fill-blank",
  ...
  },
  {
    ...
    type: "multiple-choice",
    chapter: 4,
    question: "我们来到施恩宝座前，是为了什么？",
    options: ["荣华富贵", "得怜恤，蒙恩惠，作随时的帮助", "智慧和知识", "平安和健康"],
    answer: 1,
  ...
  },
  {
    ...
    answer: false,
    explanation: "不正确。希伯来书5:12批评他们按理早应作师傅，却仍需要别人把初步的道理再教给他们。",
  },
  {
    id: "c5-fb-1",
    type: "fill-blank",
  ...
  },
  {
    ...
    answer: "麦基洗德",
    hint: "希伯来书5:10",
    explanation: "希伯来书5:10：并蒙神照着麦基洗德的等次，称祂为大祭司。",
  },
  ...
  // ===== Chapter 6 =====
  {
    ...
    answer: 1,
    explanation: "希伯来书6:1说，我们应当离开基督道理的开端，竭力进到完全的地步。",
  },
  {
    id: "c6-mc-2",
    type: "multiple-choice",
  ...
  },
  {
    ...
    type: "true-false",
    chapter: 6,
    question: "我们有的盼望如同灵魂的锚，又坚固又牢靠，且通入幔内。",
    answer: true,
    explanation: "正确。希伯来书6:19：我们有这指望，如同灵魂的锚，又坚固又牢靠，且通入幔内。",
  },
  {
    id: "c6-tf-2",
    type: "true-false",
  ...
  },
  {
    ...
    type: "fill-blank",
    chapter: 6,
    question: "希伯来书6:19说，我们有这指望，如同灵魂的___，又坚固又牢靠，且通入幔内。",
    answer: "锚",
    hint: "希伯来书6:19",
    explanation: "希伯来书6:19：我们有这指望，如同灵魂的锚，又坚固又牢靠，且通入幔内。",
  },
  {
    id: "c6-fb-2",
    type: "fill-blank",
